...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Number of Review posts on homepage",
						"desc" => "Set the number of Review posts to show on homepage.",
						"id" => "w2f_review_number",
						"std" => "5",
						"class" => "mini",
						"type" => "text");

	$options[] = array( "name" => "Number of Top Games on homepage",
						"desc" => "Set the number of Top Games to show on homepage.",
						"id" => "w2f_top_number",
						"std" => "5",
						"class" => "mini",
						"type" => "text");		
	...
	$options[] = array( "name" => "Game videos Carousel",
						"desc" => "Check if you want to show the game video carousel.",
						"id" => "w2f_video_slide",
						"std" => "1",
						"type" => "checkbox");	
	
	$options[] = array( "name" => "Number of videos on carousel",
						"desc" => "Set the number of videos on carousel.",
						"id" => "w2f_video_number",
						"std" => "5",
						"class" => "mini",
						"type" => "text");	
